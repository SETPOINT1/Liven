/**
 * SVG Icon components for Liven Dashboard
 * Clean, professional icons matching the design system
 */

export function DashboardIcon({ size = 20, color = 'currentColor' }) {
  return (
...
export function ParcelIcon({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function EventIcon({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function LogoIcon({ size = 36 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 36 36" fill="none">
      <rect width="36" height="36" rx="10" fill="#0C2340" />
      <path d="M10 22V14L18 10L26 14V22L18 26L10 22Z" fill="white" fillOpacity="0.9" />
      <path d="M18 10V26" stroke="white" strokeWidth="1.5" strokeOpacity="0.5" />
      <path d="M10 14L26 22" stroke="white" strokeWidth="1.5" strokeOpacity="0.3" />
      <path d="M26 14L10 22" stroke="white" strokeWidth="1.5" strokeOpacity="0.3" />
    </svg>
  );
}
...
export function DashboardHeroIcon({ size = 56 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 56 56" fill="none">
      <circle cx="28" cy="28" r="28" fill="#2B6CB0" />
      <rect x="17" y="20" width="8" height="16" rx="2" fill="white" fillOpacity="0.9" />
      <rect x="27" y="16" width="8" height="20" rx="2" fill="white" fillOpacity="0.7" />
      <rect x="22" y="24" width="8" height="12" rx="2" fill="white" fillOpacity="0.5" />
    </svg>
  );
}
...
export function HeartIcon({ size = 20, color = 'currentColor', filled = false }) {
  return (
...
export function LocationIcon({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
